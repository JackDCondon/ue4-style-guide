...
A Fork for S1T2 - From Allars Guide
...
### Perforce Directory Set up

FIles in the perforce should be set up as follows

PerforceRoot/Projects/Client/PorjectName/ProjectName
